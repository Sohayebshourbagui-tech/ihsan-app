...
export const STATUS = { NONE: 0, PROGRESS: 1, MEMORIZED: 2 };
...
export function loadProgress(surah) {
...
export function saveProgress(surahNum, progress) {
...
export function getSurahMemorizedCount(surahN, surahA) {
  if (typeof window === "undefined") return 0;
  try {
    const d = localStorage.getItem(lsKey(surahN));
    if (!d) return 0;
